 ...
 */
__device__ static void tinymt32_init(tinymt32_status_t* tinymt, uint32_t seed);
 ...
 */
__device__ static uint32_t tinymt32_uint32(tinymt32_status_t * tinymt);
 ...
 */
__device__ static float tinymt32_single(tinymt32_status_t * tinymt);
 ...
 * @return single precision floating point number
 */
__device__ static float tinymt32_single12(tinymt32_status_t * tinymt);
...
__device__ static void tinymt32_next(tinymt32_status_t * tinymt);
__device__ static uint32_t tinymt32_temper(tinymt32_status_t * tinymt);
